...
function HomeView(props) {
    ...
    const overview = (0, react_1.useMemo)(() => {
        const imp = (summary?.important || []).filter((it) => !(0, data_1.isPruned)(it.article_id || it.url) && (mods.portal || !isPortalIt(it)));
...
function ColumnView(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_bread", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_backBtn", onClick: onBack, children: "\u2039 \u8FD4\u56DE" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_breadPath", children: column ? [siteLabel, colLabel].filter(Boolean).join(' / ') : siteLabel || site })] }), phase === 'loading' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_loading", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_spinner" }), (0, jsx_runtime_1.jsx)("span", { children: "\u52A0\u8F7D\u4E2D\u2026" })] })), phase === 'error' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_msg", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_msgText", children: errMsg || '栏目加载失败。' }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_msgBtn", onClick: () => void load(), children: "\u91CD\u8BD5" })] })), phase === 'ready' && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [categories.length > 1 && ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_tags", children: categories.map((c) => ((0, jsx_runtime_1.jsx)("button", { type: "button", className: 'dsh-cau_tag' + (tag === c ? ' dsh-cau_tagOn' : ''), onClick: () => setTag(c), children: c }, c))) })), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_list", children: [visible.length === 0 && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_empty", children: "\u6682\u65E0\u5185\u5BB9" }), visible.map((r, i) => {
...
function DeadlinesView(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_bread", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_backBtn", onClick: onBack, children: "\u2039 \u8FD4\u56DE" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_breadPath", children: "\u5168\u90E8\u5F85\u529E" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_dlHint", children: ["\u6240\u6709\u542B\u622A\u6B62\u65E5\u671F\u7684\u4E8B\u9879\uFF08\u672A\u8FC7\u671F\uFF0C\u6309\u622A\u6B62\u65E5\u5347\u5E8F\uFF09\u3002\u300C\u2B50 \u6211\u7684\u4E8B\u9879\u300D\u53EF\u7CBE\u9009\u5230\u9996\u9875\u5927\u5361\u9762\u677F\uFF1B\u300C\uD83D\uDCE5 \u5F52\u6863\u300D\u540E\u4ECE\u672C\u5217\u8868\u6D88\u5931\uFF0C\u53EF\u5728\u9996\u9875\u300C\u5F52\u6863\u300D\u5165\u53E3\u627E\u56DE\u6216\u53D6\u6D88\u5F52\u6863\u3002", archivedCount > 0 && (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_dlArch", children: ["\u5DF2\u5F52\u6863 ", archivedCount, " \u6761"] })] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_chips", style: { marginBottom: 8 }, children: [7, 30, 90, 'all'].map((k) => ((0, jsx_runtime_1.jsx)("button", { type: "button", className: 'dsh-cau_dlChip' + (range === k ? ' on' : ''), onClick: () => setRange(k), children: k === 'all' ? '全部' : `剩余 ${k} 天内` }, k))) }), !summary ? ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_loading", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_spinner" }), (0, jsx_runtime_1.jsx)("span", { children: "\u52A0\u8F7D\u4E2D\u2026" })] })) : sorted.length === 0 ? ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_empty", children: ["\u5F53\u524D\u7B5B\u9009\u4E0B\u6682\u65E0\u622A\u6B62\u4E8B\u9879\uFF08\u5168\u90E8\u672A\u8FC7\u671F\u622A\u6B62\u5171 ", (summary?.deadlines || []).length, " \u6761\uFF09"] })) : ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_dlList", children: sorted.map(({ d, n }) => {
                    const id = d.article_id || d.url;
                    const mined = !!mine[id];
                    const archived = ops[id] === 'archive';
                    return ((0, jsx_runtime_1.jsxs)("div", { className: 'dsh-cau_dlRow' + (n <= 1 ? ' due' : n <= 3 ? ' soon' : ''), children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_dlTop", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_dlItem", children: d.item || '截止事项' }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_dlDate", children: [d.date, " \u00B7 ", n === 0 ? '今天' : `剩 ${n} 天`] }), d.column && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_dlCol", children: d.column })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_dlTitleWrap", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_dlTitle", title: d.title, onClick: () => onOpenArticle(id), children: d.title }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_dlAct", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: 'dsh-cau_textBtn' + (mined ? ' dsh-cau_on' : ''), disabled: busy === id, onClick: () => void toggleMine(d), children: mined ? '⭐ 已在我的事项' : '☆ 我的事项' }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_textBtn", disabled: busy === id, onClick: () => {
...
function unreadCandidates(summary) {
    ...
    if ((0, data_1.loadModules)().portal)
        return list;
    return list.filter((it) => !/tp_up/.test(String(it.url || '')));
}
...
function ensureToken() {
    const existing = (0, data_1.activeTokenValues)()[0];
    if (existing)
        return existing;
    ...
    const list = (0, data_1.loadTokens)();
...
function ArchiveView(props) {
    ...
    const refresh = () => {
        void (async () => {
            const token = (0, data_1.activeTokenValues)()[0] || (0, data_1.loadSettings)().githubToken || '';
            if (!token)
                return;
            const b = await loadBundle(token);
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_bread", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_backBtn", onClick: props.onBack, children: "\u2039 \u8FD4\u56DE" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_breadPath", children: "\u5DF2\u5F52\u6863\u5F85\u529E" })] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_dlHint", children: "\u5F52\u6863\u7684\u622A\u6B62\u4E8B\u9879\u4FDD\u7559\u5728\u8FD9\u91CC\uFF1B\u70B9\u300C\u21A9 \u53D6\u6D88\u5F52\u6863\u300D\u53EF\u56DE\u5230\u300C\u5168\u90E8\u5F85\u529E\u300D\u3002" }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_card", children: [rows.length === 0 && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_empty", children: "\u6682\u65E0\u5F52\u6863\u5F85\u529E" }), rows.map((d) => {
                        const id = d.article_id || d.url;
