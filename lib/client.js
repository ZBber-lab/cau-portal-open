...
function NewsView(props) {
    ...
    const searched = (0, react_1.useMemo)(() => q.trim()
        ? important.filter((it) => (0, data_1.matchQuery)([it.title, it.source, it.column, it.summary].filter(Boolean).join(' '), q))
        : important, [important, q]);
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_bread", children: [(0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_backBtn", onClick: props.onBack, children: [(0, jsx_runtime_1.jsx)(icons_1.Ic, { n: "chevLeft" }), "\u8FD4\u56DE"] }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_breadPath", children: ["\u8981\u95FB\uFF08", searched.length, q.trim() ? ` / ${important.length}` : '', "\uFF09"] }), important.length > 0 && ((0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_textBtn", onClick: () => {
                            setReadSet((0, data_1.markAllRead)(allIds));
                            props.onReadChange?.();
                        }, children: [(0, jsx_runtime_1.jsx)(icons_1.Ic, { n: "check" }), "\u5168\u90E8\u5DF2\u8BFB"] }))] }), phase === 'loading' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_loading", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_spinner" }), (0, jsx_runtime_1.jsx)("span", { children: "\u52A0\u8F7D\u4E2D\u2026" })] })), phase === 'ready' && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_mgSearch dsh-cau_dlSearch", type: "search", placeholder: "\u641C\u7D22\u8981\u95FB\uFF1A\u6807\u9898 / \u6765\u6E90 / \u680F\u76EE / AI \u6458\u8981\uFF08\u4E09\u7EC4\u4E00\u8D77\u641C\uFF09\u2026", value: q, onChange: (e) => setQ(e.target.value), spellCheck: false }), q.trim() && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_dlHit", children: ["\u641C\u7D22\u300C", q.trim(), "\u300D\u547D\u4E2D ", (0, jsx_runtime_1.jsx)("b", { children: searched.length }), " \u6761\uFF08\u5171 ", important.length, " \u6761\u8981\u95FB\uFF09"] })), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_tabs", role: "tablist", "aria-label": "\u8981\u95FB\u6765\u6E90\u5206\u7EC4", children: data_1.GROUP_ORDER.map((g) => {
                            const on = g === tab;
...
function DeadlinesView(props) {
    ...
    const active = (0, react_1.useMemo)(() => {
        ...
        return all.filter((d) => ops[d.article_id || d.url] !== 'archive').map((d) => ({ d, n: (0, data_1.daysLeft)(d.date) }));
    }, [summary, ops]);
    /** 当前时间范围内的条目（搜索只在这批里进行 —— 用户选「严格」口径） */
    const inRange = (0, react_1.useMemo)(() => (range === 'all' ? active : active.filter((x) => Number.isFinite(x.n) && x.n >= 0 && x.n <= range)), [active, range]);
    /** 搜索：事项名 / 标题 / 来源 / 栏目 / AI 摘要，空格分隔多关键词全部命中 */
    const rows = (0, react_1.useMemo)(() => {
        if (!q.trim())
            return inRange;
        return inRange.filter((x) => (0, data_1.matchQuery)([x.d.item, x.d.title, x.d.source, x.d.column, summary?.ai_map?.[x.d.article_id]?.summary].filter(Boolean).join(' '), q));
    }, [inRange, q, summary]);
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_bread", children: [(0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_backBtn", onClick: onBack, children: [(0, jsx_runtime_1.jsx)(icons_1.Ic, { n: "chevLeft" }), "\u8FD4\u56DE"] }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_breadPath", children: "\u5168\u90E8\u5F85\u529E" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_dlHint", children: ["\u6240\u6709\u542B\u622A\u6B62\u65E5\u671F\u7684\u4E8B\u9879\uFF08\u672A\u8FC7\u671F\uFF0C\u6309\u622A\u6B62\u65E5\u5347\u5E8F\uFF09\u3002\u300C\u6211\u7684\u4E8B\u9879\u300D\u53EF\u7CBE\u9009\u5230\u9996\u9875\u5927\u5361\u9762\u677F\uFF1B\u300C\u5F52\u6863\u300D\u540E\u4ECE\u672C\u5217\u8868\u6D88\u5931\uFF0C\u53EF\u5728\u9996\u9875\u300C\u5F52\u6863\u300D\u5165\u53E3\u627E\u56DE\u6216\u53D6\u6D88\u5F52\u6863\u3002", archivedCount > 0 && (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_dlArch", children: ["\u5DF2\u5F52\u6863 ", archivedCount, " \u6761"] })] }), (0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_mgSearch dsh-cau_dlSearch", type: "search", placeholder: "\u641C\u7D22\u5F85\u529E\uFF1A\u4E8B\u9879\u540D / \u6807\u9898 / \u6765\u6E90 / \u680F\u76EE / AI \u6458\u8981\uFF08\u53EA\u5728\u5F53\u524D\u65F6\u95F4\u8303\u56F4\u5185\uFF09\u2026", value: q, onChange: (e) => setQ(e.target.value), spellCheck: false }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_chips", style: { marginBottom: 8 }, children: [7, 30, 90, 'all'].map((k) => ((0, jsx_runtime_1.jsx)("button", { type: "button", className: 'dsh-cau_dlChip' + (range === k ? ' on' : ''), onClick: () => setRange(k), children: k === 'all' ? '全部' : `剩余 ${k} 天内` }, k))) }), q.trim() && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_dlHit", children: ["\u641C\u7D22\u300C", q.trim(), "\u300D\u547D\u4E2D ", (0, jsx_runtime_1.jsx)("b", { children: rows.length }), " \u6761 \u00B7 \u5F53\u524D\u8303\u56F4\uFF08", range === 'all' ? '全部未过期' : `剩余 ${range} 天内`, "\uFF09\u5171 ", inRange.length, " \u6761", rows.length === 0 && inRange.length > 0 && range !== 'all' ? ' —— 可把范围调成「全部」再试' : ''] })), !summary ? ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_loading", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_spinner" }), (0, jsx_runtime_1.jsx)("span", { children: "\u52A0\u8F7D\u4E2D\u2026" })] })) : sorted.length === 0 ? (q.trim() ? ((0, jsx_runtime_1.jsx)(empty_1.Empty, { icon: (0, jsx_runtime_1.jsx)(icons_1.Ic, { n: "search" }), main: `没有匹配「${q.trim()}」的待办`, sub: `当前范围（${range === 'all' ? '全部未过期' : `剩余 ${range} 天内`}）共 ${inRange.length} 条，都不含这个关键词；可换词或把时间范围调宽（全部未过期共 ${active.length} 条）` })) : ((0, jsx_runtime_1.jsx)(empty_1.Empty, { icon: (0, jsx_runtime_1.jsx)(icons_1.Ic, { n: "clipboard" }), main: "\u5F53\u524D\u7B5B\u9009\u4E0B\u6682\u65E0\u622A\u6B62\u4E8B\u9879", sub: `全部未过期截止共 ${(summary?.deadlines || []).length} 条` }))) : ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_dlList", children: sorted.map(({ d, n }) => {
                    const id = d.article_id || d.url;
                    const mined = !!mine[id];
...
exports.CauWordmarkGlyph = CauWordmarkGlyph;
 ...
 *     走 createElement 零成本。
 */
function CauWordmarkGlyph(props) {
    const s = props.size || 26;
    return React.createElement('svg', { className: props.className, width: s, height: s, viewBox: '0 0 24 24', 'aria-hidden': 'true' }, React.createElement('text', {
        x: 12,
        y: 12,
        textAnchor: 'middle',
