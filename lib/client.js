...
function HomeView(props) {
    ...
    const getMineEditDraft = (id) => {
        if (id) {
            ...
            return { id, name: m?.title || '', date: (0, data_1.mineDeadlineOf)(m) || '', url: m?.article_url || '' };
        }
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [phase === 'loading' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_loading", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_spinner" }), (0, jsx_runtime_1.jsx)("span", { children: "\u52A0\u8F7D\u4E2D\u2026" })] })), phase === 'maybe-token' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_msg", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_msgText", children: "\u9700\u8981 GitHub \u53EA\u8BFB\u4EE4\u724C\u624D\u80FD\u8BFB\u53D6\u4E91\u7AEF\u6570\u636E\u3002" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_msgBtn dsh-cau_msgBtnPrimary", onClick: () => void load(), children: "\u53BB\u914D\u7F6E" })] })), phase === 'error' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_msg", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_msgText", children: "\u4E91\u7AEF\u8BFB\u53D6\u5931\u8D25\u3002" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_msgBtn", onClick: () => void load(), children: "\u91CD\u8BD5" })] })), phase === 'ready' && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [!summary && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_hint", children: "\u805A\u5408\u6570\u636E\u751F\u6210\u4E2D\u2026\u680F\u76EE\u4E0E\u5FEB\u6377\u5165\u53E3\u4ECD\u53EF\u7528\u3002" }), (summary?.summaryReason === 'missing' || summary?.summaryReason === 'error') && ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_hint", children: "\u2B50 \u5F85\u529E\u4E0E\u8981\u95FB\u805A\u5408\u6682\u4E0D\u53EF\u7528\uFF08\u4E91\u7AEF summary.json \u672A\u5C31\u7EEA\uFF09\uFF0C\u5176\u4F59\u529F\u80FD\u6B63\u5E38\u3002" })), mods.deadline && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_sec", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_secHead", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_secMark" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_secTitle", children: "\u2B50 \u6211\u7684\u4E8B\u9879" }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_secActs", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_textBtn", onClick: () => startMineEdit(), children: "+ \u81EA\u5B9A\u4E49\u4E8B\u9879" }), allDeadlines > 0 && ((0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_textBtn", onClick: onViewDeadlines, children: ["\u5168\u90E8\u5F85\u529E ", allDeadlines, " \u203A"] }))] })] }), mineRows.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_empty", children: "\u70B9\u300C+ \u81EA\u5B9A\u4E49\u4E8B\u9879\u300D\u76F4\u63A5\u8BB0\u5F55\u8981\u529E\u7684\u4E8B\uFF1B\u6216\u5728\u300C\u5168\u90E8\u5F85\u529E\u300D/\u6587\u7AE0\u9875\u70B9\u300C\u2B50 \u6211\u7684\u4E8B\u9879\u300D\u7CBE\u9009\uFF08\u9644\u539F\u6587\u94FE\u63A5\uFF0C\u81EA\u52A8\u51FA\u73B0\u5728\u5173\u6CE8\u533A\uFF09\u3002" })) : ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mineGrid", children: mineRows.map(({ id, title, date, column, artUrl }) => {
                                    ...
                                    return ((0, jsx_runtime_1.jsxs)("div", { className: 'dsh-cau_mineCard' + (expired ? ' expired' : ''), children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mineDate", children: [mm ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mineDay", children: +mm[2] }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_mineYM", children: [+mm[1], "\u6708"] })] })) : ((0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mineYM", children: "\u672A\u8BBE\u65E5\u671F" })), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mineCount", children: !Number.isFinite(n) ? '—' : expired ? '已过期' : n === 0 ? '今天' : `剩 ${n} 天` })] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mineTitle", title: title, children: title }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mineFoot", children: [column && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mineCol", children: column }), !column && (0, jsx_runtime_1.jsx)("span", {}), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_mineActs", children: [artUrl && canArticle && ((0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_mineArt", title: "\u6253\u5F00\u5BF9\u5E94\u6587\u7AE0", onClick: (e) => {
                                                                    ...
                                                                    setMine((0, data_1.loadMine)());
                                                                }, children: "\u2606 \u79FB\u51FA" })] })] }), mineEdit && (mineEdit.id || '') === id && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mineEdit", onClick: (e) => e.stopPropagation(), children: [(0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", placeholder: "\u4E8B\u9879\u540D\uFF08\u8981\u505A\u4EC0\u4E48\uFF09", value: mineEdit.name, onChange: (e) => setMineEdit({ ...mineEdit, name: e.target.value }) }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mineEditRow", children: [(0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", style: { maxWidth: 160 }, type: "date", value: mineEdit.date, onChange: (e) => setMineEdit({ ...mineEdit, date: e.target.value }) }), (0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", placeholder: "\u539F\u6587\u94FE\u63A5\uFF08\u53EF\u7A7A\uFF09", value: mineEdit.url, onChange: (e) => setMineEdit({ ...mineEdit, url: e.target.value }) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mineEditRow", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_textBtn dsh-cau_on", onClick: () => {
                                                                    if (mineEdit.id)
                                ...
                                }) })), mineEdit && !mineEdit.id && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mineEdit dsh-cau_mineEditNew", children: [(0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", placeholder: "\u4E8B\u9879\u540D\uFF08\u8981\u505A\u4EC0\u4E48\uFF09", value: mineEdit.name, onChange: (e) => setMineEdit({ ...mineEdit, name: e.target.value }) }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mineEditRow", children: [(0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", style: { maxWidth: 160 }, type: "date", value: mineEdit.date, onChange: (e) => setMineEdit({ ...mineEdit, date: e.target.value }) }), (0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", placeholder: "\u539F\u6587\u94FE\u63A5\uFF08\u53EF\u7A7A\uFF09", value: mineEdit.url, onChange: (e) => setMineEdit({ ...mineEdit, url: e.target.value }) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mineEditRow", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_textBtn dsh-cau_on", onClick: () => {
