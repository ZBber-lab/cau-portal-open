...
function computeAlerts() {
    ...
    if (s.notifyOn) {
        ...
        if (perm === 'default')
            out.push({ level: 'warn', text: '系统通知已开启但尚未授权：设置 → 面板偏好 → 点「请求通知授权」' });
        else if (perm === 'denied')
            out.push({ level: 'warn', text: '系统通知已开启但被浏览器拒绝：请在浏览器站点设置中允许通知' });
        else if (perm === 'unsupported')
            out.push({ level: 'warn', text: '系统通知已开启，但当前浏览器不支持通知 API' });
    }
    ...
    for (const [k, exp] of Object.entries(keyExp)) {
        ...
        const left = Math.floor((d - Date.now()) / 86400e3);
        if (left < 0)
            out.push({ level: 'error', text: `凭据「${k}」已过期（${exp}），请前往 GitHub 续期` });
        else if (left <= 30)
            out.push({ level: 'warn', text: `凭据「${k}」将于 ${left} 天后过期（${exp}）` });
    }
    return out;
}
/**
...
function HomeView(props) {
    ...
    const newsRow = (it, i, sibs) => {
        ...
        return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_impRow", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_impDot", "data-read": read ? '1' : '0' }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_impMain", onClick: () => openArt(it, sibs, i), children: [(0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_impTop", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_impTitle", children: it.title }), (0, jsx_runtime_1.jsx)(ImpBadge, { level: it.importance }), (0, data_1.matchRules)(watchRules, it).length > 0 && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_impHit", title: "\u547D\u4E2D\u5173\u6CE8\u89C4\u5219", children: "\uD83C\uDFAF" })] }), it.summary && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_impSummary", children: it.summary }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_impMeta", children: [it.column, it.source, fmtCn(it.time)].filter(Boolean).join(' · ') })] }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_impActs", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: 'dsh-cau_followBtn' + (follow.some((x) => x.id === id) ? ' dsh-cau_on' : ''), title: follow.some((x) => x.id === id) ? '取消关注' : '加入关注', onClick: () => toggleFollow({ id, title: it.title, url: it.url, time: it.time, source: it.source, column: it.column, importance: it.importance, summary: it.summary }), children: follow.some((x) => x.id === id) ? '⭐' : '☆' }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_impArch", title: "\u5F52\u6863\uFF08\u4ECE\u6B64\u5904\u79FB\u9664\uFF0C\u53EF\u5728\u300C\u5F52\u6863\u300D\u89C6\u56FE\u4E2D\u627E\u56DE\uFF09", onClick: () => archiveFromNews(id), children: "\uD83D\uDCE5" })] })] }, id));
    };
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [phase === 'loading' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_loading", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_spinner" }), (0, jsx_runtime_1.jsx)("span", { children: "\u52A0\u8F7D\u4E2D\u2026" })] })), phase === 'maybe-token' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_msg", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_msgText", children: "\u9700\u8981 GitHub \u53EA\u8BFB\u4EE4\u724C\u624D\u80FD\u8BFB\u53D6\u4E91\u7AEF\u6570\u636E\u3002" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_msgBtn dsh-cau_msgBtnPrimary", onClick: () => void load(), children: "\u53BB\u914D\u7F6E" })] })), phase === 'error' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_msg", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_msgText", children: "\u4E91\u7AEF\u8BFB\u53D6\u5931\u8D25\u3002" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_msgBtn", onClick: () => void load(), children: "\u91CD\u8BD5" })] })), phase === 'ready' && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [!summary && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_hint", children: "\u805A\u5408\u6570\u636E\u751F\u6210\u4E2D\u2026\u680F\u76EE\u4E0E\u5FEB\u6377\u5165\u53E3\u4ECD\u53EF\u7528\u3002" }), (summary?.summaryReason === 'missing' || summary?.summaryReason === 'error') && ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_hint", children: "\u2B50 \u5F85\u529E\u4E0E\u8981\u95FB\u805A\u5408\u6682\u4E0D\u53EF\u7528\uFF08\u4E91\u7AEF summary.json \u672A\u5C31\u7EEA\uFF09\uFF0C\u5176\u4F59\u529F\u80FD\u6B63\u5E38\u3002" })), (overview.high > 0 || overview.due > 0 || overview.hits > 0) && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_ov", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_ovTitle", children: "\uD83D\uDCCC \u4ECA\u65E5\u8981\u89C8" }), overview.high > 0 && (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_ovChip hl", children: ["\u9AD8\u91CD\u8981\u65B0\u8FDB ", overview.high] }), overview.due > 0 && (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_ovChip due", children: ["\u23F0 3 \u5929\u5185\u622A\u6B62 ", overview.due] }), overview.hits > 0 && (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_ovChip hit", children: ["\uD83C\uDFAF \u547D\u4E2D\u5173\u6CE8 ", overview.hits] }), overview.top.length > 0 && ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_ovList", children: overview.top.map((it) => ((0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_ovRow", onClick: () => openArt(it, [], 0), children: [(0, jsx_runtime_1.jsx)("em", { children: it.tag === 'high' ? '高' : '🎯' }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_ovTitleTxt", children: it.title }), (0, jsx_runtime_1.jsx)("i", { children: [it.column, it.source].filter(Boolean).join(' · ') })] }, String(it.article_id || it.url)))) }))] })), mods.deadline && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_sec", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_secHead", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_secMark" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_secTitle", children: "\u2B50 \u6211\u7684\u4E8B\u9879" }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_secActs", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_textBtn", onClick: () => startMineEdit(), children: "+ \u81EA\u5B9A\u4E49\u4E8B\u9879" }), allDeadlines > 0 && ((0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_textBtn", onClick: onViewDeadlines, children: ["\u5168\u90E8\u5F85\u529E ", allDeadlines, " \u203A"] }))] })] }), mineRows.length === 0 ? ((0, jsx_runtime_1.jsx)(empty_1.Empty, { icon: "\uD83D\uDDD2\uFE0F", main: "\u8FD8\u6CA1\u6709\u6211\u7684\u4E8B\u9879", sub: "\u70B9\u300C+ \u81EA\u5B9A\u4E49\u4E8B\u9879\u300D\u76F4\u63A5\u8BB0\u5F55\u8981\u529E\u7684\u4E8B\uFF1B\u6216\u5728\u300C\u5168\u90E8\u5F85\u529E\u300D/\u6587\u7AE0\u9875\u70B9\u300C\u2B50 \u6211\u7684\u4E8B\u9879\u300D\u7CBE\u9009\uFF08\u9644\u539F\u6587\u94FE\u63A5\uFF09" })) : ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mineGrid", children: mineRows.map(({ id, title, date, column, artUrl, artTitle }) => {
                                    ...
                                    return ((0, jsx_runtime_1.jsxs)("div", { className: 'dsh-cau_mineCard' + (expired ? ' expired' : urgent ? (n <= 1 ? ' due' : ' soon') : ''), children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mineDate", children: [mm ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mineDay", children: +mm[2] }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_mineYM", children: [+mm[1], "\u6708"] })] })) : ((0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mineYM", children: "\u672A\u8BBE\u65E5\u671F" })), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mineCount", children: !Number.isFinite(n) ? '—' : expired ? '已过期' : n === 0 ? '今天' : `剩 ${n} 天` })] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mineTitle", title: title, children: title }), artTitle && artTitle !== title && ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mineSrc", title: artTitle, children: artTitle })), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mineFoot", children: [column && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mineCol", children: column }), !column && (0, jsx_runtime_1.jsx)("span", {}), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_mineActs", children: [artUrl && canArticle && ((0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_mineArt", title: "\u6253\u5F00\u5BF9\u5E94\u6587\u7AE0", onClick: (e) => {
                                                ...
                                                }, children: "\u4FDD\u5B58" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_textBtn", onClick: () => setMineEdit(null), children: "\u53D6\u6D88" })] })] })), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_deadlineEntry", children: [(0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_deadlineEntryMain", role: "button", onClick: onViewDeadlines, children: ["\uD83D\uDCCB \u5168\u90E8\u5F85\u529E\uFF08\u542B\u6240\u6709\u622A\u6B62\u4E8B\u9879\uFF09", (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_deadlineEntryArrow", children: "\u7B5B\u9009\u4E0E\u67E5\u770B \u203A" })] }), archiveCount > 0 && ((0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_textBtn", onClick: onViewArchive, children: ["\u5F52\u6863 ", archiveCount] }))] })] })), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_sec", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_secHead", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_secMark" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_secTitle", children: "\uD83D\uDCCC \u8981\u95FB" }), important.length > 0 && ((0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_textBtn", onClick: () => {
                                            setReadSet((0, data_1.markAllRead)(allImportantIds));
                                            onReadChange?.();
                                        }, children: "\u5168\u90E8\u5DF2\u8BFB" }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_card", children: [!summary && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_empty", children: "\u805A\u5408\u6570\u636E\u6682\u4E0D\u53EF\u7528" }), mods.portal && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_newsSubHead", children: [(0, jsx_runtime_1.jsx)("span", { children: "\uD83C\uDFDB \u6821\u5185\u5E73\u53F0" }), (0, jsx_runtime_1.jsxs)("em", { children: [portalNews.length, " \u6761"] })] })), mods.portal && summary && portalNews.length === 0 && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_empty", children: "\u6682\u65E0\u6821\u5185\u5E73\u53F0\u91CD\u8981\u901A\u77E5" }), mods.portal && portalNews.map((it, i) => newsRow(it, i, portalNews.map((x) => ({ id: x.article_id || x.url, title: x.title })))), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_newsSubHead", children: [(0, jsx_runtime_1.jsx)("span", { children: "\u2726 \u5176\u4ED6\u6765\u6E90" }), (0, jsx_runtime_1.jsxs)("em", { children: [otherNews.length, " \u6761"] })] }), summary && otherNews.length === 0 && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_empty", children: "\u6682\u65E0\u5176\u4ED6\u6765\u6E90\u91CD\u8981\u901A\u77E5" }), otherNews.map((it, i) => newsRow(it, i, otherNews.map((x) => ({ id: x.article_id || x.url, title: x.title }))))] })] }), mods.deadline && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_sec", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_secHead", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_secMark" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_secTitle", children: "\u2B50 \u5173\u6CE8" }), follow.length > 0 && ((0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_textBtn", onClick: onViewFollow, children: ["\u67E5\u770B\u5168\u90E8 ", follow.length] }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_card", children: [follow.length === 0 && (0, jsx_runtime_1.jsx)(empty_1.Empty, { icon: "\u2B50", main: "\u8FD8\u6CA1\u6709\u5173\u6CE8\u5185\u5BB9", sub: "\u5728\u6587\u7AE0\u91CC\u70B9\u300C\u52A0\u5165\u5173\u6CE8\u300D\uFF0C\u91CD\u8981\u5185\u5BB9\u96C6\u4E2D\u5728\u8FD9\uFF0C\u4E0D\u8BBE\u4E0A\u9650" }), follow.slice(0, 5).map((it) => ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_row", children: [(0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_rowMain", onClick: () => onOpenArticle(it.id, follow.map((x) => ({ id: x.id, title: x.title })), 0), children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_rowTitle", children: it.title }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_rowMeta", children: [it.column, it.source, fmtCn(it.time)].filter(Boolean).join(' · ') })] }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_followBtn dsh-cau_on", title: "\u53D6\u6D88\u5173\u6CE8", onClick: () => toggleFollow(it), children: "\u2B50" })] }, it.id)))] })] })), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_sec", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_secHead", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_secMark" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_secTitle", children: "\uD83D\uDCDA \u680F\u76EE\u9891\u9053" })] }), (indexJson?.sites || []).filter((site) => mods.portal || site.id !== 'portal').map((site) => ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_colGroup", children: [(0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_colSiteBtn", onClick: () => onOpenColumn(site.id, null), children: [site.name, " \u203A"] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_colChips", children: (site.columns || []).map((c) => ((0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_chip dsh-cau_chipBtn", onClick: () => onOpenColumn(site.id, c.key), children: [c.name, typeof c.items === 'number' && (0, jsx_runtime_1.jsx)("em", { className: "dsh-cau_chipCount", children: c.items })] }, c.key))) })] }, site.id)))] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_sec", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_secHead", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_secMark" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_secTitle", children: "\uD83D\uDD17 \u5FEB\u6377\u5165\u53E3" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_quick", children: [(0, jsx_runtime_1.jsx)("a", { className: "dsh-cau_quickLink", href: "https://one.cau.edu.cn", target: "_blank", rel: "noreferrer", children: "\u7EDF\u4E00\u95E8\u6237 \u2197" }), (0, jsx_runtime_1.jsx)("a", { className: "dsh-cau_quickLink", href: "https://clst.cau.edu.cn", target: "_blank", rel: "noreferrer", children: "\u5B66\u9662\u5B98\u7F51 \u2197" }), (0, jsx_runtime_1.jsx)("a", { className: "dsh-cau_quickLink", href: "https://jwc.cau.edu.cn", target: "_blank", rel: "noreferrer", children: "\u6559\u52A1\u5904 \u2197" }), (0, jsx_runtime_1.jsx)("a", { className: "dsh-cau_quickLink", href: "https://news.cau.edu.cn", target: "_blank", rel: "noreferrer", children: "\u6821\u65B0\u95FB\u7F51 \u2197" })] })] })] }))] }));
}
...
function ColumnView(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_bread", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_backBtn", onClick: onBack, children: "\u2039 \u8FD4\u56DE" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_breadPath", children: column ? [siteLabel, colLabel].filter(Boolean).join(' / ') : siteLabel || site })] }), phase === 'loading' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_loading", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_spinner" }), (0, jsx_runtime_1.jsx)("span", { children: "\u52A0\u8F7D\u4E2D\u2026" })] })), phase === 'error' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_msg", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_msgText", children: errMsg || '栏目加载失败。' }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_msgBtn", onClick: () => void load(), children: "\u91CD\u8BD5" })] })), phase === 'ready' && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [categories.length > 1 && ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_tags", children: categories.map((c) => ((0, jsx_runtime_1.jsx)("button", { type: "button", className: 'dsh-cau_tag' + (tag === c ? ' dsh-cau_tagOn' : ''), onClick: () => setTag(c), children: c }, c))) })), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_list", children: [visible.length === 0 && (0, jsx_runtime_1.jsx)(empty_1.Empty, { icon: "\uD83D\uDCC4", main: "\u6682\u65E0\u5185\u5BB9", sub: "\u6362\u4E2A\u680F\u76EE\u6216\u7B5B\u9009\u6761\u4EF6\u8BD5\u8BD5" }), visible.map((r, i) => {
...
function ManageView(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_bread", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_backBtn", onClick: onBack, children: "\u2039 \u9000\u51FA\u7BA1\u7406" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_breadPath", children: "\u6570\u636E\u7BA1\u7406" })] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mgIntro", children: "\u6309\u3010\u8D77\u59CB\u65E5\u671F ~ \u7EC8\u6B62\u65E5\u671F\u3011\u7B5B\u9009\uFF08\u8D77\u59CB\u7559\u7A7A=\u6700\u65E9\uFF0C\u7EC8\u6B62\u7559\u7A7A=\u81F3\u4ECA\uFF1B\u65E0\u65E5\u671F\u6761\u76EE\u53EA\u5728\u90FD\u4E0D\u9650\u65F6\u51FA\u73B0\uFF09\u3002\u5220\u9664\u4E0D\u53EF\u6062\u590D\uFF1A\u672C\u5730\u7ACB\u5373\u9690\u85CF\uFF0C\u4E91\u7AEF\u5C06\u4E8E\u4E0B\u4E00\u8F6E\u6293\u53D6\uFF08\u22642 \u5C0F\u65F6\uFF09\u540E\u771F\u6B63\u5220\u9664\uFF1B\u5173\u6CE8\u4E2D\u7684\u6587\u7AE0\u5C06\u4FDD\u7559\u672C\u5730\u7F13\u5B58\u53EF\u8BFB\u3002" }), phase === 'loading' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_loading", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_spinner" }), (0, jsx_runtime_1.jsx)("span", { children: "\u52A0\u8F7D\u6570\u636E\u76EE\u5F55\u2026" })] })), phase === 'error' && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mgMsg error", children: error }), phase === 'ready' && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgToolbar", children: [(0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_mgSearch", type: "search", placeholder: "\u641C\u7D22\u6807\u9898\u6216\u94FE\u63A5\u2026\uFF08\u4E0E\u7B5B\u9009\u53E0\u52A0\uFF09", value: query, onChange: (e) => setQuery(e.target.value) }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgFilters", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mgLabel", children: "\u65E5\u671F" }), (0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_mgDate", type: "date", value: dateFrom, max: dateTo || undefined, title: "\u8D77\u59CB\u65E5\u671F\uFF08\u7559\u7A7A=\u6700\u65E9\uFF09", onChange: (e) => setDateFrom(e.target.value) }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mgLabel", children: "~" }), (0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_mgDate", type: "date", value: dateTo, min: dateFrom || undefined, title: "\u7EC8\u6B62\u65E5\u671F\uFF08\u7559\u7A7A=\u81F3\u4ECA\uFF09", onChange: (e) => setDateTo(e.target.value) }), (dateFrom || dateTo) && ((0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_mgChipBtn", onClick: () => { setDateFrom(''); setDateTo(''); }, children: "\u91CD\u7F6E\uFF08\u5168\u90E8\uFF09" })), (0, jsx_runtime_1.jsxs)("label", { className: "dsh-cau_mgCheck", title: "\u53EA\u663E\u793A\u5DF2\u5F52\u6863\u7684\u6570\u636E", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: archOnly, onChange: (e) => setArchOnly(e.target.checked) }), "\u53EA\u770B\u5DF2\u5F52\u6863 ", archOnly ? `(${archCount})` : ''] }), (0, jsx_runtime_1.jsxs)("select", { className: "dsh-cau_mgSel", value: siteFilter, onChange: (e) => setSiteFilter(e.target.value), title: "\u6309\u7AD9\u70B9\u7B5B\u9009", children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: "\u5168\u90E8\u7AD9\u70B9" }), sites.map(([k, n]) => ((0, jsx_runtime_1.jsx)("option", { value: k, children: n }, k)))] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgActs", children: [(0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_mgBtn", onClick: selectAllShown, disabled: !shown.length, title: "\u52FE\u9009\u5F53\u524D\u7B5B\u9009/\u7AD9\u70B9/\u641C\u7D22\u547D\u4E2D\u7684\u5168\u90E8\u6570\u636E", children: ["\u9009\u62E9\u5168\u90E8\u5F53\u524D\u7B5B\u9009\uFF08", shown.length, "\uFF09"] }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_mgBtn", onClick: clearSel, disabled: !sel.size, children: "\u6E05\u7A7A\u9009\u62E9" })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgBar", children: ["\u5DF2\u9009 ", (0, jsx_runtime_1.jsx)("b", { children: sel.size }), " \u6761\uFF08\u6211\u7684\u4E8B\u9879 ", selMine, " \u00B7 \u5173\u6CE8\u4E2D ", selFollow, selArch > 0 ? ` · 已归档 ${selArch}` : '', "\uFF09", (0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_mgDel", disabled: !sel.size || busy, onClick: () => setConfirm(true), children: ["\u5220\u9664\u6240\u9009\uFF08", sel.size, "\uFF09"] })] }), confirm && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgConfirm", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgConfirmText", children: ["\u786E\u5B9A\u5220\u9664\u6240\u9009 ", (0, jsx_runtime_1.jsx)("b", { children: sel.size }), " \u6761\u6570\u636E\uFF1F", ' ', (selMine > 0 || selFollow > 0) && ((0, jsx_runtime_1.jsx)("b", { style: { color: 'var(--dsw-alias-state-warn,#b8860b)' }, children: [selMine > 0 && `${selMine} 条我的事项`, selFollow > 0 && `${selFollow} 条关注中`].filter(Boolean).join('，') })), ' ', (selMine > 0 || selFollow > 0) && (0, jsx_runtime_1.jsx)("span", { children: "\uFF08\u672C\u5730\u7F13\u5B58\u4ECD\u53EF\u8BFB\uFF0C\u4F46\u4E91\u7AEF\u5C06\u5220\u9664\uFF0C\u6211\u7684\u4E8B\u9879\u539F\u6587\u94FE\u63A5\u5C06\u5931\u6548\uFF09" }), "\u5220\u9664\u4E0D\u53EF\u6062\u590D\u3002"] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgConfirmActs", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_mgBtn warn", disabled: busy, onClick: () => void doDelete(), children: busy ? '提交中…' : '确认删除' }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_mgBtn", disabled: busy, onClick: () => setConfirm(false), children: "\u53D6\u6D88" })] })] })), done && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mgMsg ok", children: done }), error && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mgMsg error", children: error }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgList", children: [shown.length === 0 && (0, jsx_runtime_1.jsx)(empty_1.Empty, { icon: "\uD83D\uDD0D", main: "\u6CA1\u6709\u7B26\u5408\u6761\u4EF6\u7684\u6570\u636E", sub: "\u653E\u5BBD\u65E5\u671F/\u7AD9\u70B9\u7B5B\u9009\u6216\u6E05\u7A7A\u641C\u7D22\u8BCD\u518D\u8BD5" }), sites
                                ...
                                .map((g) => ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgGroup", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mgGroupName", children: g.n }), g.items.map((r) => {
                                        ...
                                        return ((0, jsx_runtime_1.jsxs)("label", { className: 'dsh-cau_mgRow' + (selMineRow ? ' pro' : ''), children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: sel.has(r.id), onChange: () => toggle(r.id) }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_mgRowMain", children: [(0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_mgRowTitle", children: [highlight(r.title, query), r.mined && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mgMine", title: "\u6211\u7684\u4E8B\u9879", children: "\u25CE" }), r.followed && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mgStar", title: "\u5173\u6CE8\u4E2D", children: "\u2605" }), r.archived && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mgArch", title: "\u5DF2\u5F52\u6863\uFF08\u5168\u90E8\u5F85\u529E\u4E0D\u518D\u663E\u793A\uFF0C\u53EF\u53D6\u6D88\u5F52\u6863\uFF09", children: "\uD83D\uDCE5" })] }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_mgRowSub", children: [r.colName, r.date ? ` · ${r.date}` : ' · 无日期', r.url && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mgRowUrl", children: highlight(r.url, query) })] })] })] }, r.id));
                                    })] }, g.k)))] })] }))] }));
}
...
function DeadlinesView(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_bread", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_backBtn", onClick: onBack, children: "\u2039 \u8FD4\u56DE" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_breadPath", children: "\u5168\u90E8\u5F85\u529E" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_dlHint", children: ["\u6240\u6709\u542B\u622A\u6B62\u65E5\u671F\u7684\u4E8B\u9879\uFF08\u672A\u8FC7\u671F\uFF0C\u6309\u622A\u6B62\u65E5\u5347\u5E8F\uFF09\u3002\u300C\u2B50 \u6211\u7684\u4E8B\u9879\u300D\u53EF\u7CBE\u9009\u5230\u9996\u9875\u5927\u5361\u9762\u677F\uFF1B\u300C\uD83D\uDCE5 \u5F52\u6863\u300D\u540E\u4ECE\u672C\u5217\u8868\u6D88\u5931\uFF0C\u53EF\u5728\u9996\u9875\u300C\u5F52\u6863\u300D\u5165\u53E3\u627E\u56DE\u6216\u53D6\u6D88\u5F52\u6863\u3002", archivedCount > 0 && (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_dlArch", children: ["\u5DF2\u5F52\u6863 ", archivedCount, " \u6761"] })] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_chips", style: { marginBottom: 8 }, children: [7, 30, 90, 'all'].map((k) => ((0, jsx_runtime_1.jsx)("button", { type: "button", className: 'dsh-cau_dlChip' + (range === k ? ' on' : ''), onClick: () => setRange(k), children: k === 'all' ? '全部' : `剩余 ${k} 天内` }, k))) }), !summary ? ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_loading", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_spinner" }), (0, jsx_runtime_1.jsx)("span", { children: "\u52A0\u8F7D\u4E2D\u2026" })] })) : sorted.length === 0 ? ((0, jsx_runtime_1.jsx)(empty_1.Empty, { icon: "\uD83D\uDCCB", main: "\u5F53\u524D\u7B5B\u9009\u4E0B\u6682\u65E0\u622A\u6B62\u4E8B\u9879", sub: `全部未过期截止共 ${(summary?.deadlines || []).length} 条` })) : ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_dlList", children: sorted.map(({ d, n }) => {
                    const id = d.article_id || d.url;
                    const mined = !!mine[id];
                    const archived = ops[id] === 'archive';
                    return ((0, jsx_runtime_1.jsxs)("div", { className: 'dsh-cau_dlRow' + (n <= 1 ? ' due' : n <= 3 ? ' soon' : ''), children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_dlTop", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_dlItem", children: d.item || '截止事项' }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_dlDate", children: [d.date, " \u00B7 ", n < 0 ? '已过期' : n === 0 ? '今天' : `剩 ${n} 天`] }), d.column && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_dlCol", children: d.column })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_dlTitleWrap", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_dlTitle", title: d.title, onClick: () => onOpenArticle(id), children: d.title }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_dlAct", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: 'dsh-cau_textBtn' + (mined ? ' dsh-cau_on' : ''), disabled: busy === id, onClick: () => void toggleMine(d), children: mined ? '⭐ 已在我的事项' : '☆ 我的事项' }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_textBtn", disabled: busy === id, onClick: () => {
...
function CauSettings(props) {
    ...
    // ---------- 子页：统一门户登录（阶段5） ----------
    const [portalUser, setPortalUser] = (0, react_1.useState)('');
    const [portalPwd, setPortalPwd] = (0, react_1.useState)('');
    const [portalState, setPortalState] = (0, react_1.useState)('idle');
    const [portalAct, setPortalAct] = (0, react_1.useState)('');
    const [portalMsg, setPortalMsg] = (0, react_1.useState)('');
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_set", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setPageHead", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setSubBack", onClick: () => setPage('home'), children: "\u2039 \u8FD4\u56DE" }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", style: { margin: 0 }, children: page === 'ai' ? 'AI 加工 · 模型配置' : page === 'tokens' ? '令牌管理' : page === 'prefs' ? '面板偏好 · 引用协同' : page === 'cloud' ? '数据源' : page === 'mail' ? '每日邮件报告' : '安全 · 门户' }), errCount > 0 && (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_setWarn", children: ["\u26A0 \u6709 ", errCount, " \u9879\u914D\u7F6E\u95EE\u9898"] })] }), page === 'ai' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlocks", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlock", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", children: "\u6A21\u578B\u9009\u62E9" }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setDesc", children: "\u72EC\u7ACB\u914D\u7F6E\u69FD\uFF1A\u7528\u4E8E\u9762\u677F\u6309\u9700\u52A0\u5DE5\uFF08AI \u6458\u8981/\u5206\u7C7B/\u91CD\u8981\u5EA6/deadline\uFF09\u4E0E\u540E\u7EED\u76D1\u63A7\uFF0C\u4E0E\u4E3B\u5BF9\u8BDD\u6A21\u578B\u4E92\u4E0D\u5F71\u54CD\u3002\u6362\u6A21\u578B\u53EA\u5F71\u54CD\u4E4B\u540E\u7684\u52A0\u5DE5\uFF0C\u6570\u636E\u65E0\u9700\u91CD\u722C\u3002" }), !sessionId || !modelDirectories ? ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setHint", children: !modelDirectories ? '模型目录服务不可用（按需加工将使用服务端默认模型）。' : '当前没有打开的会话——打开一个会话后即可从 DSH 模型目录中选择。' })) : modelState === 'loading' ? ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setHint", children: "\u6A21\u578B\u76EE\u5F55\u52A0\u8F7D\u4E2D\u2026" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", onClick: () => void loadModelDir(), children: "\u5237\u65B0" })] })) : modelState === 'fail' ? ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setErr", children: modelNote }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", onClick: () => void loadModelDir(), children: "\u91CD\u8BD5" })] })) : modelState === 'ok' && groups.length === 0 ? ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setHint", children: "\u6A21\u578B\u76EE\u5F55\u4E3A\u7A7A\uFF08\u68C0\u67E5 provider \u914D\u7F6E\u540E\u91CD\u8BD5\uFF09\u3002" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", onClick: () => void loadModelDir(), children: "\u5237\u65B0" })] })) : modelState === 'ok' ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", children: [(0, jsx_runtime_1.jsx)("select", { className: "dsh-cau_setSelect", value: selGroup?.id || '', onChange: (e) => { const g = groups.find((x) => x.id === e.target.value); if (g?.models?.length)
                                ...
                                })] }), !tokEditing ? ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setRow", children: (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", onClick: () => startEdit(), children: "+ \u6DFB\u52A0\u4EE4\u724C" }) })) : ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_infoCard", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", style: { fontSize: 12 }, children: tokEditing ? '编辑令牌' : '添加令牌' }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setRow", children: (0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", placeholder: "\u540D\u79F0\uFF08\u5982 GitHub \u6570\u636E\u4EE4\u724C\uFF09", value: tokDraft.name, onChange: (e) => setTokDraft({ ...tokDraft, name: e.target.value }) }) }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setRow", children: (0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", placeholder: "\u7528\u9014\u8BF4\u660E\uFF08\u5982 \u8BFB\u53D6\u4E91\u7AEF\u6570\u636E\uFF09", value: tokDraft.usage, onChange: (e) => setTokDraft({ ...tokDraft, usage: e.target.value }) }) }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setRow", children: (0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", type: "password", placeholder: "\u4EE4\u724C\u503C\uFF08\u4EC5\u672C\u673A\uFF1B\u4EC5\u767B\u8BB0\u8FC7\u671F\u65E5\u7684\u53EF\u7559\u7A7A\uFF09", value: tokDraft.value, onChange: (e) => setTokDraft({ ...tokDraft, value: e.target.value }), spellCheck: false }) }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", children: [(0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", style: { maxWidth: 170 }, type: "date", value: tokDraft.expires, onChange: (e) => setTokDraft({ ...tokDraft, expires: e.target.value }) }), (0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", placeholder: "\u7BA1\u7406\u9875 URL\uFF08\u9ED8\u8BA4 GitHub \u4EE4\u724C\u9875\uFF09", value: tokDraft.adminUrl, onChange: (e) => setTokDraft({ ...tokDraft, adminUrl: e.target.value }) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", disabled: !tokDraft.name.trim(), onClick: saveTokDraft, children: "\u4FDD\u5B58" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", onClick: () => setTokEditing(null), children: "\u53D6\u6D88" })] })] })), savedFlash && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setOk", children: "\u5DF2\u4FDD\u5B58 \u2713" })] }) })), page === 'prefs' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlocks", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlock", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", children: "\u9605\u8BFB\u4E0A\u4E0B\u6587\u5F15\u7528" }), (0, jsx_runtime_1.jsxs)("label", { className: "dsh-cau_setCheck", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: !!settings.autoAttach, onChange: (e) => upd({ ...settings, autoAttach: e.target.checked }) }), "\u6253\u5F00\u6587\u7AE0\u65F6\u81EA\u52A8\u9644\u52A0\u9605\u8BFB\u4E0A\u4E0B\u6587\uFF08\u53D1\u9001\u63D0\u95EE\u65F6\u4F5C\u4E3A\u5F15\u7528\u6750\u6599\uFF09"] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_infoCard", children: (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_setDesc", children: ["\u6587\u7AE0\u9605\u8BFB\u9875\u70B9\u300C", (0, jsx_runtime_1.jsx)("b", { children: "\u5F15\u7528\u5230\u5BF9\u8BDD" }), "\u300D\u2192 \u6587\u7AE0\u4F5C\u4E3A\u4E0A\u4E0B\u6587\u5F15\u7528\u5230\u804A\u5929\u8F93\u5165\u6846\u4E0A\u65B9\uFF08chip\uFF09\uFF0C\u8349\u7A3F\u6CE8\u5165\u6807\u8BB0\u884C\uFF1B\u53D1\u9001\u540E\u81EA\u52A8\u89E3\u9664\u3002\u5173\u95ED\u672C\u6A21\u5757\uFF08\u5361\u7247\u5F00\u5173\uFF09\u540E\u5F15\u7528\u6309\u94AE\u4E0E\u4E0A\u4E0B\u6587\u6761\u9690\u85CF\u3002"] }) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlock", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", children: "\u5F85\u529E\u63D0\u9192 \u00B7 \u5173\u6CE8" }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setDesc", children: "\u9996\u9875\u300C\u5F85\u529E\u5361\u300D\u5C55\u793A\u672A\u8FC7\u671F\u622A\u6B62\u4E8B\u9879\uFF08\u22647 \u5929\uFF09\uFF0C\u652F\u6301\u7559\u5B58/\u5F52\u6863\uFF1B\u5173\u6CE8\u65E0\u4E0A\u9650\uFF0C\u6587\u7AE0\u9875 \u2605 \u52A0\u5165\u3002\u5173\u95ED\u672C\u6A21\u5757\u540E\u5F85\u529E\u5361\u4E0E\u5173\u6CE8\u5165\u53E3\u9690\u85CF\u3002" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlock", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", children: "\uD83C\uDFAF \u5173\u6CE8\u89C4\u5219\uFF08\u5173\u952E\u8BCD/\u6765\u6E90\u8BA2\u9605\uFF09" }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setDesc", children: "\u547D\u4E2D\u7684\u901A\u77E5\u5728\u9996\u9875\u300C\u4ECA\u65E5\u8981\u89C8\u300D\u6807 \uD83C\uDFAF\u3001\u53EF\u89E6\u53D1\u7CFB\u7EDF\u901A\u77E5\uFF08\u4E0B\u65B9\u5F00\u5173\uFF09\u3002\u89C4\u5219\u4FDD\u5B58\u4E8E\u672C\u673A\u6D4F\u89C8\u5668\uFF1B\u5173\u952E\u793A\u4F8B\uFF1A\u63A8\u514D\u3001\u9009\u8BFE\u3001\u5956\u5B66\u91D1\u3001\u6210\u7EE9\u3001\u571F\u5730\u5B66\u9662\u3001\u6559\u52A1\u5904\u2026" }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_tokList", children: [rules.length === 0 && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setHint", children: "\u6682\u65E0\u89C4\u5219\u3002\u6DFB\u52A0\u5173\u952E\u8BCD\u540E\u4F1A\u6807\u51FA\u6240\u6709\u6765\u6E90\u547D\u4E2D\u7684\u6761\u76EE\uFF08\u591A\u89C4\u5219\u53D6\u5E76\u96C6\uFF09\u3002" }), rules.map((r) => ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_tok", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_tokMain", children: [(0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_tokName", children: [r.keyword, !r.enabled && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_cardBadge off", children: "\u5DF2\u505C\u7528" })] }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_tokMeta", children: [r.source ? `来源含「${r.source}」` : '全部来源', r.minImportance ? ` · 重要度≥${r.minImportance === '高' ? '高' : '高/中'}` : ' · 不限重要度'] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_tokActs", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_tokBtn", onClick: () => persistRules(rules.map((x) => (x.id === r.id ? { ...x, enabled: !x.enabled } : x))), children: r.enabled ? '停用' : '启用' }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_tokBtn danger", onClick: () => persistRules(rules.filter((x) => x.id !== r.id)), children: "\u5220\u9664" })] })] }, r.id)))] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_infoCard", children: [(0, jsx_runtime_1.jsxs)("label", { className: "dsh-cau_mineLabel", children: [(0, jsx_runtime_1.jsx)("span", { children: "\u5173\u952E\u8BCD\uFF08\u5FC5\u586B\uFF0C\u5982 \u63A8\u514D / \u9009\u8BFE / \u5956\u5B66\u91D1\uFF09" }), (0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", placeholder: "\u5982\uFF1A\u63A8\u514D / \u9009\u8BFE / \u5956\u5B66\u91D1 / \u571F\u5730\u5B66\u9662", value: ruleDraft.keyword, onChange: (e) => setRuleDraft({ ...ruleDraft, keyword: e.target.value }) })] }), (0, jsx_runtime_1.jsxs)("label", { className: "dsh-cau_mineLabel", children: [(0, jsx_runtime_1.jsx)("span", { children: "\u6765\u6E90\u5305\u542B\uFF08\u53EF\u7A7A\uFF0C\u5982 \u6559\u52A1\u5904 / \u56E2\u59D4 / \u571F\u5730\uFF09" }), (0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_setInput", placeholder: "\u53EF\u7A7A\uFF08\u5982 \u6559\u52A1\u5904 / \u56E2\u59D4 / \u571F\u5730\uFF09", value: ruleDraft.source, onChange: (e) => setRuleDraft({ ...ruleDraft, source: e.target.value }) })] }), (0, jsx_runtime_1.jsxs)("label", { className: "dsh-cau_mineLabel", children: [(0, jsx_runtime_1.jsx)("span", { children: "\u91CD\u8981\u5EA6\u4E0B\u9650\uFF08\u4E0D\u9650 / \u9AD8\u6216\u4E2D / \u53EA\u8981\u9AD8\uFF09" }), (0, jsx_runtime_1.jsxs)("select", { className: "dsh-cau_setSelect", value: ruleDraft.minImportance, onChange: (e) => setRuleDraft({ ...ruleDraft, minImportance: e.target.value }), children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: "\u4E0D\u9650\u91CD\u8981\u5EA6" }), (0, jsx_runtime_1.jsx)("option", { value: "\u4E2D", children: "\u9AD8\u6216\u4E2D" }), (0, jsx_runtime_1.jsx)("option", { value: "\u9AD8", children: "\u53EA\u8981\u9AD8" })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", disabled: !ruleDraft.keyword.trim(), onClick: addRule, children: "\u6DFB\u52A0\u89C4\u5219" }), rules.length > 0 && ((0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn danger", onClick: () => persistRules([]), children: "\u6E05\u7A7A\u5168\u90E8" }))] })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlock", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", children: "\uD83D\uDD14 \u7CFB\u7EDF\u901A\u77E5\uFF08\u53EF\u9009\uFF09" }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setDesc", children: "\u9875\u9762\u5F00\u7740\uFF08\u4E0D\u9650\u662F\u5426\u6253\u5F00\u9762\u677F\uFF09\u65F6\u6BCF 10 \u5206\u949F\u68C0\u67E5\uFF1A\u547D\u4E2D\u5173\u6CE8\u89C4\u5219\u6216\u65B0\u589E\u9AD8\u91CD\u8981\u901A\u77E5\u5373\u5F39\u7CFB\u7EDF\u901A\u77E5\u3002\u9996\u6B21\u9700\u70B9\u300C\u8BF7\u6C42\u901A\u77E5\u6388\u6743\u300D\u3002" }), (0, jsx_runtime_1.jsxs)("label", { className: "dsh-cau_setCheck", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: !!settings.notifyOn, onChange: (e) => upd({ ...settings, notifyOn: e.target.checked }) }), "\u542F\u7528\u7CFB\u7EDF\u901A\u77E5"] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", onClick: () => {
                                            if (typeof Notification === 'undefined')
                                                return;
                                            Notification.requestPermission().then((p) => setNotifyStatus(p));
                                        }, children: "\u8BF7\u6C42\u901A\u77E5\u6388\u6743" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setHint", children: notifyStatus === 'granted' ? '已授权 ✓' : notifyStatus === 'denied' ? '已被拒绝（需在浏览器站点设置中允许通知）' : notifyStatus === 'unsupported' ? '当前环境不支持通知' : '未授权' })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlock", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", children: "\u9762\u677F\u56FA\u5B9A" }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setDesc", children: "\u9762\u677F\u5934\u90E8 \uD83D\uDCCC \u56FA\u5B9A\u540E\uFF0C\u70B9\u51FB\u5916\u90E8/Esc \u4E0D\u5173\u95ED\uFF0C\u4EC5 \u2715 \u5173\u95ED\uFF08\u72B6\u6001\u6301\u4E45\u5316\uFF09\u3002" })] })] })), page === 'cloud' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlocks", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlock", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", style: { gap: 8 }, children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", style: { margin: 0 }, children: "\u2601\uFE0F \u6570\u636E\u6E90 \u00B7 GitHub \u4E91\u7AEF" }), (0, jsx_runtime_1.jsx)(Toggle, { on: mods.cloud, onToggle: () => toggleMod('cloud'), label: "\u5207\u6362 \u6570\u636E\u6E90" })] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setDesc", children: "\u6570\u636E\u5B58\u4E8E GitHub \u79C1\u6709\u4ED3\u5E93\uFF08`zhouxuanting52-lab/cau-portal` \u7684 data/\uFF09\uFF0C\u7531 Actions \u6BCF 2 \u5C0F\u65F6\u6293\u53D6+AI \u52A0\u5DE5\u5E76\u63D0\u4EA4\uFF1B\u9762\u677F\u4E0E MCP \u76F4\u63A5\u8BFB\u4E91\u7AEF\u3002\u5173\u95ED\u672C\u5F00\u5173\u5C06\u5B8C\u5168\u505C\u6B62\u6570\u636E\u8BFB\u53D6\uFF08\u9876\u90E8\u7EA2\u6761\u63D0\u9192\uFF09\u3002" }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", disabled: cloudState === 'loading', onClick: () => void checkCloud(), children: cloudState === 'loading' ? '检查中…' : '连通性检查' }), cloudState === 'ok' && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setOk", children: cloudMsg }), cloudState === 'fail' && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setErr", children: cloudMsg })] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_links", children: KEY_LINKS.slice(0, 3).map((l) => ((0, jsx_runtime_1.jsxs)("a", { className: "dsh-cau_link", href: l.url, target: "_blank", rel: "noreferrer", children: [l.label, " \u2197"] }, l.key))) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlock", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", style: { gap: 8 }, children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", style: { margin: 0 }, children: "\uD83C\uDFDB \u7EDF\u4E00\u95E8\u6237 \u00B7 \u6821\u5185\u901A\u77E5" }), (0, jsx_runtime_1.jsx)(Toggle, { on: mods.portal, onToggle: () => toggleMod('portal'), label: "\u5207\u6362 \u7EDF\u4E00\u95E8\u6237" })] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setDesc", children: "\u95E8\u6237\u6570\u636E\u6765\u81EA\u7EDF\u4E00\u95E8\u6237\uFF08one.cau.edu.cn\uFF09\uFF0C\u9700\u767B\u5F55\u6821\u56ED\u7F51/SSO \u770B\u539F\u6587\uFF08\u8D26\u53F7\u5165\u53E3\u89C1\u9996\u9875\u300C\u7EDF\u4E00\u95E8\u6237 \u00B7 \u8D26\u53F7\u300D\uFF09\u3002\u5173\u95ED\u6B64\u5F00\u5173\u540E\uFF0C\u9762\u677F\u9690\u85CF\u95E8\u6237\u901A\u77E5\uFF08\u8981\u95FB / \u680F\u76EE / \u5F85\u529E / \u672A\u8BFB\u8BA1\u6570\uFF09\uFF1B\u5BF9\u8BDD\u67E5\u8BE2\u4E0D\u53D7\u5F71\u54CD\u3002\u9ED8\u8BA4\u5F00\u542F\u3002" })] })] })), page === 'mail' && ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setBlocks", children: (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlock", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", children: "\uD83D\uDCE7 \u6BCF\u65E5\u62A5\u544A\u90AE\u4EF6" }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setDesc", children: ["\u6BCF\u5929 ", (0, jsx_runtime_1.jsx)("b", { children: mailCfg.sendTime }), " \u81EA\u52A8\u628A\u300C\u4ECA\u65E5\u9AD8\u91CD\u8981\u901A\u77E5 + 3 \u5929\u5185\u622A\u6B62 + \u547D\u4E2D\u5173\u6CE8\u89C4\u5219 + \u6628\u65E5\u56DE\u987E\u300D\u63A8\u9001\u5230\u4F60\u7684\u90AE\u7BB1\uFF1B\u82E5\u53D1\u9001\u65F6\u95F4\u5DF2\u8FC7\u624D\u5F00\u673A\uFF0C\u4F1A\u81EA\u52A8", (0, jsx_runtime_1.jsx)("b", { children: "\u8865\u53D1" }), "\u3002\u53D1\u4EF6\u4E0E\u6536\u4EF6\u53EF\u586B\u540C\u4E00\u4E2A\u90AE\u7BB1\uFF08\u81EA\u5DF1\u53D1\u7ED9\u81EA\u5DF1\uFF09\u3002\u6388\u6743\u7801\u53EA\u5B58\u672C\u673A\uFF08\u4ED3\u5E93\u5916\uFF09\uFF0C\u4E0D\u4F1A\u4E0A\u4F20\u6216\u663E\u793A\u5728\u65E5\u5FD7\u91CC\u3002"] }), (0, jsx_runtime_1.jsx)("label", { className: "dsh-cau_setLabel", htmlFor: "cauMailSender", children: "\u53D1\u4EF6\u90AE\u7BB1\uFF08\u5982 QQ \[REDACTED-EMAIL]\uFF09" }), (0, jsx_runtime_1.jsx)("input", { id: "cauMailSender", className: "dsh-cau_setInput", value: mailCfg.sender, onChange: (e) => setMailCfg({ ...mailCfg, sender: e.target.value }), placeholder: "\u5982 [REDACTED-EMAIL]\uFF08QQ/163/Outlook/\u519C\u5927\u90AE\u7BB1\u5747\u53EF\uFF09", autoComplete: "off", spellCheck: false }), mailCfg.provider && (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setHint", children: ["\u5DF2\u8BC6\u522B\u670D\u52A1\u5546\uFF1A", mailCfg.provider, "\uFF08SMTP \u81EA\u52A8\u914D\u7F6E\uFF0C\u65E0\u9700\u624B\u586B\uFF09"] }), (0, jsx_runtime_1.jsxs)("label", { className: "dsh-cau_setLabel", htmlFor: "cauMailCode", children: ["\u90AE\u7BB1\u6388\u6743\u7801 ", mailCfg.hasCode ? '（已保存；留空则不修改）' : ''] }), (0, jsx_runtime_1.jsx)("input", { id: "cauMailCode", className: "dsh-cau_setInput", type: "password", value: mailCfg.authCode, onChange: (e) => setMailCfg({ ...mailCfg, authCode: e.target.value }), placeholder: mailCfg.hasCode ? '已保存授权码，留空保持不变' : 'QQ 邮箱：设置→账户→开启 SMTP→生成授权码', autoComplete: "new-password" }), (0, jsx_runtime_1.jsx)("label", { className: "dsh-cau_setLabel", htmlFor: "cauMailTo", children: "\u6536\u4EF6\u90AE\u7BB1\uFF08\u7559\u7A7A = \u53D1\u4EF6\u90AE\u7BB1\uFF09" }), (0, jsx_runtime_1.jsx)("input", { id: "cauMailTo", className: "dsh-cau_setInput", value: mailCfg.recipient, onChange: (e) => setMailCfg({ ...mailCfg, recipient: e.target.value }), placeholder: "\u7559\u7A7A\u5219\u53D1\u7ED9\u81EA\u5DF1\uFF08\u4E0E\u53D1\u4EF6\u90AE\u7BB1\u76F8\u540C\uFF09", autoComplete: "off", spellCheck: false }), (0, jsx_runtime_1.jsx)("label", { className: "dsh-cau_setLabel", htmlFor: "cauMailTime", children: "\u53D1\u9001\u65F6\u95F4\uFF08\u672C\u673A\u65F6\u95F4\uFF0C\u9ED8\u8BA4 08:00\uFF09" }), (0, jsx_runtime_1.jsx)("input", { id: "cauMailTime", className: "dsh-cau_setInput", type: "time", value: mailCfg.sendTime, onChange: (e) => setMailCfg({ ...mailCfg, sendTime: e.target.value || '08:00' }) }), (0, jsx_runtime_1.jsxs)("label", { className: "dsh-cau_setCheck", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: mailCfg.enabled, onChange: (e) => setMailCfg({ ...mailCfg, enabled: e.target.checked }) }), "\u542F\u7528\u6BCF\u65E5\u90AE\u4EF6\u62A5\u544A\uFF08\u4FDD\u5B58\u540E\u7ACB\u5373\u751F\u6548\uFF1A\u6B21\u65E5 ", mailCfg.sendTime || '08:00', " \u8D77\u81EA\u52A8\u53D1\u9001\uFF09"] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", disabled: mailState === 'loading', onClick: () => void doMailSave(), children: mailState === 'loading' ? '保存中…' : '💾 保存配置' }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", disabled: mailState === 'loading', onClick: () => void doMailTest(), children: "\u2709\uFE0F \u6D4B\u8BD5\u53D1\u9001" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", onClick: () => void refreshMailInfo(), children: "\u5237\u65B0\u72B6\u6001" })] }), mailState === 'loading' && mailMsg && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setWarn", children: mailMsg }), mailState === 'ok' && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setOk", children: mailMsg }), mailState === 'fail' && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setErr", children: mailMsg }), mailState === 'idle' && mailMsg && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setHint", children: mailMsg }), mailLast && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setHint", children: mailLast }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_infoCard", children: (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_setDesc", children: ["\u5173\u6CE8\u89C4\u5219\uFF08\uD83C\uDFAF\uFF09\u5DF2\u540C\u6B65 ", mailCfg.rulesCount, " \u6761\u7ED9\u62A5\u544A\uFF1B\u6539\u89C4\u5219\u540E\u81EA\u52A8\u66F4\u65B0\u3002\u627E\u4E0D\u5230\u90AE\u7BB1\u6388\u6743\u7801\uFF1F\u6700\u5E38\u7528\u8DEF\u5F84\u2014\u2014", (0, jsx_runtime_1.jsx)("b", { children: "QQ \u90AE\u7BB1" }), "\uFF1A\u7F51\u9875\u7248 \u2192 \u8BBE\u7F6E \u2192 \u8D26\u6237 \u2192 \u5F00\u542F\u300CSMTP \u670D\u52A1\u300D\u2192 \u6309\u63D0\u793A\u53D1\u77ED\u4FE1\u540E\u751F\u6210 16 \u4F4D\u6388\u6743\u7801\uFF08\u4E0D\u662F QQ \u5BC6\u7801\uFF09\u3002", (0, jsx_runtime_1.jsx)("b", { children: "163" }), "\uFF1A\u8BBE\u7F6E \u2192 POP3/SMTP/IMAP \u2192 \u5F00\u542F SMTP \u2192 \u5BA2\u6237\u7AEF\u6388\u6743\u5BC6\u7801\u3002"] }) })] }) })), page === 'security' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlocks", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlock", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", children: "\u7EDF\u4E00\u95E8\u6237\u767B\u5F55\uFF08\u6821\u5185\u901A\u77E5\u63A5\u5165\uFF09" }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setDesc", children: ["\u586B\u5165\u5B66\u53F7/\u804C\u5DE5\u53F7\u4E0E\u5BC6\u7801 \u2192\u300C\u4E00\u952E\u767B\u5F55\u300D\u2192 \u5728", (0, jsx_runtime_1.jsx)("b", { children: "\u672C\u673A" }), "\u81EA\u52A8\u767B\u5F55\u7EDF\u4E00\u95E8\u6237\uFF08one.cau.edu.cn\uFF09\u5E76\u4FDD\u5B58\u767B\u5F55\u6001\u3002\u5BC6\u7801\u4EC5\u5B58\u672C\u673A\u5DE5\u5177\u76EE\u5F55\uFF08gitignore\uFF0C\u4E0D\u8FDB\u4ED3\u5E93\u3001\u4E0D\u8FDB\u5BF9\u8BDD/\u65E5\u5FD7\uFF09\uFF1Bcookie \u8FC7\u671F\u65F6\u81EA\u52A8\u7528\u4FDD\u5B58\u7684\u5BC6\u7801\u91CD\u767B\u3002\u5F53\u524D\u7248\u672C\u4EC5\u6293\u53D6\u300C\u6821\u5185\u901A\u77E5\u300D\u5217\u8868\uFF08\u6807\u9898/\u65F6\u95F4/\u6765\u6E90\uFF09\uFF0C\u4E0D\u6293\u6B63\u6587\u3002"] }), (0, jsx_runtime_1.jsx)("label", { className: "dsh-cau_setLabel", htmlFor: "cauPortalUser", children: "\u8D26\u53F7\uFF08\u804C\u5DE5\u53F7/\u5B66\u53F7\uFF09" }), (0, jsx_runtime_1.jsx)("input", { id: "cauPortalUser", className: "dsh-cau_setInput", value: portalUser, onChange: (e) => setPortalUser(e.target.value), placeholder: "\u804C\u5DE5\u53F7/\u5B66\u53F7", autoComplete: "off", spellCheck: false }), (0, jsx_runtime_1.jsx)("label", { className: "dsh-cau_setLabel", htmlFor: "cauPortalPwd", children: "\u5BC6\u7801" }), (0, jsx_runtime_1.jsx)("input", { id: "cauPortalPwd", className: "dsh-cau_setInput", type: "password", value: portalPwd, onChange: (e) => setPortalPwd(e.target.value), placeholder: "\u5BC6\u7801\uFF08\u4EC5\u63D0\u4EA4\u672C\u673A\u670D\u52A1\u7AEF\uFF09", autoComplete: "new-password" }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setRow", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", disabled: portalState === 'loading', onClick: () => void doPortalLogin(), children: portalState === 'loading' ? (portalAct === 'sync' ? '同步中…' : '登录中…') : '🔑 一键登录 / 测试' }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", disabled: portalState === 'loading', onClick: () => void doPortalSync(), children: "\u27F3 \u7ACB\u5373\u540C\u6B65\u6821\u5185\u901A\u77E5" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn danger", onClick: () => void doPortalClear(), children: "\u6E05\u9664\u5BC6\u7801\u4E0E\u767B\u5F55\u6001" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_setBtn", onClick: () => void fetchPortalStatus(), children: "\u67E5\u770B\u767B\u5F55\u72B6\u6001" })] }), portalState === 'loading' && portalMsg && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setWarn", children: portalMsg }), portalState === 'ok' && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setOk", children: portalMsg }), portalState === 'fail' && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setErr", children: portalMsg }), portalState === 'idle' && portalMsg && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_setHint", children: portalMsg })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_setBlock", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setTitle", children: "\u5BC6\u94A5\u4E0E\u91CD\u8981\u94FE\u63A5" }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_setDesc", children: "\u5E38\u7528\u9875\u9762\u4E00\u952E\u76F4\u8FBE\uFF1B\u4EE4\u724C\u8BE6\u60C5\u4E0E\u8FC7\u671F\u65E5\u5728\u300C\u4EE4\u724C\u7BA1\u7406\u300D\u9875\u7EF4\u62A4\u3002" }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_links", children: KEY_LINKS.map((l) => ((0, jsx_runtime_1.jsxs)("a", { className: "dsh-cau_link", href: l.url, target: "_blank", rel: "noreferrer", children: [l.label, " \u2197"] }, l.key))) })] })] }))] }));
}
...
function FollowView(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_bread", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_backBtn", onClick: props.onBack, children: "\u2039 \u8FD4\u56DE" }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_breadPath", children: ["\u5173\u6CE8\uFF08", list.length, "\uFF09"] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_card", children: [list.length === 0 && (0, jsx_runtime_1.jsx)(empty_1.Empty, { icon: "\u2B50", main: "\u8FD8\u6CA1\u6709\u5173\u6CE8\u5185\u5BB9", sub: "\u5728\u6587\u7AE0\u9875\u70B9\u300C\u52A0\u5165\u5173\u6CE8\u300D\u5373\u53EF\u6536\u85CF" }), list.map((it) => ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_row", children: (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_rowMain", onClick: () => props.onOpenArticle(it.id), children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_rowTitle", children: it.title }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_rowMeta", children: [it.column, it.source].filter(Boolean).join(' · ') })] }) }, it.id)))] })] }));
}
...
.dsh-cau_panelClose{flex:none;display:flex;align-items:center;justify-content:center;width:24px;height:24px;padding:0;border:none;border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary,#666);cursor:pointer;font-size:13px;line-height:1}
...
.dsh-cau_panelPin{flex:none;display:flex;align-items:center;justify-content:center;width:24px;height:24px;padding:0;border:none;border-radius:8px;background:transparent;color:var(--dsw-alias-label-tertiary,#888);cursor:pointer}
...
.dsh-cau_panelTab{flex:none;height:24px;padding:0 10px;border:1px solid var(--dsw-alias-border-inverted,rgba(15,17,21,.14));border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary,#666);font-size:11px;cursor:pointer;white-space:nowrap}
...
.dsh-cau_empty{display:flex;flex-direction:column;align-items:center;gap:4px;padding:16px 12px;text-align:center;font-size:12px;color:var(--dsw-alias-label-tertiary,#999)}
.dsh-cau_emptyIcon{font-size:20px;line-height:1;opacity:.9}
.dsh-cau_emptyMain{font-size:12px;line-height:18px;color:var(--dsw-alias-label-tertiary,#999)}
.dsh-cau_emptySub{font-size:11px;line-height:16px;color:var(--dsw-alias-label-tertiary,#999);opacity:.85}
.dsh-cau_textBtn{padding:0 4px;border:none;border-radius:6px;background:transparent;color:var(--dsw-alias-state-business-primary,#4176e6);font-size:11px;cursor:pointer}
...
.dsh-cau_backBtn{flex:none;padding:3px 8px;border:none;border-radius:8px;background:transparent;color:var(--dsw-alias-state-business-primary,#4176e6);font-size:12px;cursor:pointer}
...
.dsh-cau_followBtn{flex:none;align-self:flex-start;height:24px;min-width:24px;margin-right:10px;padding:0 4px;border:none;border-radius:8px;background:transparent;color:var(--dsw-alias-label-tertiary,#999);font-size:15px;line-height:24px;cursor:pointer}
...
.dsh-cau_impArch{flex:none;height:24px;min-width:24px;padding:0 4px;border:none;border-radius:8px;background:transparent;color:var(--dsw-alias-label-tertiary,#999);font-size:13px;line-height:24px;cursor:pointer}
...
.dsh-cau_portalCard{display:flex;flex-direction:column;gap:9px;padding:12px;border:1px dashed color-mix(in srgb,var(--cau-brand,#008038) 55%,transparent);border-radius:12px;background:color-mix(in srgb,var(--cau-brand,#008038) 6%,transparent)}
...
.dsh-cau_badge{flex:none;font-size:10px;line-height:16px;padding:0 5px;border-radius:6px;font-weight:500}
...
.dsh-cau_quickLink{display:flex;align-items:center;justify-content:center;padding:7px 8px;border:1px solid var(--dsw-alias-border-inverted,rgba(15,17,21,.12));border-radius:8px;font-size:12px;color:var(--dsw-alias-label-secondary,#555);text-decoration:none}
...
.dsh-cau_aimgTag{padding:0 5px;border-radius:6px;background:var(--dsw-alias-interactive-bg-hover,rgba(0,0,0,.06));color:var(--dsw-alias-label-tertiary,#888)}
...
.dsh-cau_aBtn{display:inline-flex;align-items:center;padding:5px 12px;border:1px solid var(--dsw-alias-border-inverted,rgba(15,17,21,.16));border-radius:8px;background:transparent;color:var(--dsw-alias-label-primary,#111);font-size:12px;cursor:pointer;text-decoration:none}
...
.dsh-cau_anavBtn{flex:none;padding:5px 10px;border:none;border-radius:8px;background:transparent;color:var(--dsw-alias-state-business-primary,#4176e6);font-size:12px;cursor:pointer}
.dsh-cau_anavBtn:hover{background:var(--dsw-alias-interactive-bg-hover,rgba(0,0,0,.05))}
.dsh-cau_acacheTag{padding:0 5px;border-radius:6px;background:color-mix(in srgb,var(--cau-brand) 10%,transparent);color:var(--cau-brand)}
...
.dsh-cau_mgSearch{width:100%;box-sizing:border-box;height:28px;padding:0 10px;border:1px solid var(--dsw-alias-border-inverted,rgba(15,17,21,.14));border-radius:8px;background:transparent;color:var(--dsw-alias-label-primary,#111);font-size:12px;outline:none}
...
.dsh-cau_mgSel{height:24px;padding:0 6px;border:1px solid var(--dsw-alias-border-inverted,rgba(15,17,21,.14));border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary,#666);font-size:11px}
...
.dsh-cau_mgCheck{display:inline-flex;align-items:center;gap:4px;height:24px;padding:0 8px;border:1px solid var(--dsw-alias-border-inverted,rgba(15,17,21,.12));border-radius:8px;color:var(--dsw-alias-label-secondary,#666);font-size:11px;cursor:pointer}
.dsh-cau_mgCheck input{accent-color:var(--cau-brand)}
.dsh-cau_mgChipBtn{height:24px;padding:0 10px;border:1px dashed var(--dsw-alias-border-inverted,rgba(15,17,21,.2));border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary,#666);font-size:11px;cursor:pointer}
.dsh-cau_mgActs{display:flex;gap:6px;flex-wrap:wrap}
.dsh-cau_mgBtn{height:26px;padding:0 12px;border:1px solid var(--dsw-alias-border-inverted,rgba(15,17,21,.16));border-radius:8px;background:transparent;color:var(--dsw-alias-label-primary,#111);font-size:12px;cursor:pointer}
...
.dsh-cau_mgDel{flex:none;height:28px;padding:0 14px;border:none;border-radius:8px;background:var(--dsw-alias-state-error-primary,#e5484d);color:#fff;font-size:12px;cursor:pointer}
...
.dsh-cau_mgGroup{border:1px solid var(--dsw-alias-border-inverted,rgba(15,17,21,.08));border-radius:12px;overflow:hidden}
...
.dsh-cau_mineArt{flex:none;height:24px;padding:0 9px;border:1px solid color-mix(in srgb,var(--cau-brand,#008038) 45%,transparent);border-radius:8px;background:color-mix(in srgb,var(--cau-brand,#008038) 10%,transparent);color:var(--cau-brand,#008038);font-size:11px;cursor:pointer}
