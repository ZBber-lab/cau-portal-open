...
function NewsRow(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_impRow", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_impDot", "data-read": read ? '1' : '0', style: color ? { background: color } : undefined }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_impMain", onClick: props.onOpen, children: [(0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_impTop", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_impTitle", children: it.title }), (0, jsx_runtime_1.jsx)(ImpBadge, { level: it.importance }), hit && ((0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_impHit", title: "\u547D\u4E2D\u5173\u6CE8\u89C4\u5219", children: (0, jsx_runtime_1.jsx)(icons_1.Ic, { n: "target" }) }))] }), it.summary && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_impSummary", children: it.summary }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_impMeta", children: [it.column, it.source, fmtCn(it.time)].filter(Boolean).join(' · ') })] }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_impActs", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: 'dsh-cau_followBtn' + (followed ? ' dsh-cau_on' : ''), title: followed ? '取消关注' : '加入关注', onClick: props.onToggleFollow, children: (0, jsx_runtime_1.jsx)(icons_1.Ic, { n: followed ? 'starFill' : 'star' }) }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_impArch", title: "\u5F52\u6863\uFF08\u4ECE\u6B64\u5904\u79FB\u9664\uFF0C\u53EF\u5728\u300C\u5F52\u6863\u300D\u89C6\u56FE\u4E2D\u627E\u56DE\uFF09", onClick: props.onArchive, children: (0, jsx_runtime_1.jsx)(icons_1.Ic, { n: "archive" }) })] })] }));
}
...
function ref() {
    ...
    if (!r || !Array.isArray(r.attached) || typeof r.open !== 'object' || !(r.subs instanceof Set)) {
        r = { attached: [], open: null, draft: null, draftAck: 0, subs: new Set() };
...
function CauPanel(props) {
    ...
    const [topInset, setTopInset] = (0, react_1.useState)(() => (pane ? 12 : measureTopInset()));
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.CAU_TAB_ID = exports.CAU_TAB_KIND = exports.USE_OFFICIAL_SIDEBAR = void 0;
...
exports.followSessions = followSessions;
...
exports.getWantOpen = getWantOpen;
exports.setWantOpen = setWantOpen;
...
function getWantOpen() {
    return ref().wantOpen;
}
function setWantOpen(v) {
    const r = ref();
    const next = !!v;
    if (r.wantOpen === next)
        return;
...
exports.USE_OFFICIAL_SIDEBAR = true;
...
function openArticleInPortal(id) {
    if (!exports.USE_OFFICIAL_SIDEBAR) {
        (0, bus_1.requestOpenArticle)(id);
        return false;
    }
 ...
 * 返回取消订阅函数。
 */
function followSessions(ctx) {
    if (!exports.USE_OFFICIAL_SIDEBAR)
        return () => { };
    try {
        const list = ctx?.sessions?.list;
        if (!list?.subscribe || !list?.getSnapshot)
            return () => { };
...
function createCauTabBody(deps) {
    return function CauTabBody(props) {
        ...
        (0, react_1.useEffect)(() => {
            if (!signal)
                return;
            const onAbort = () => (0, state_1.setWantOpen)(false);
            if (signal.aborted)
                onAbort();
        ...
        return (0, jsx_runtime_1.jsx)(Panel, { mode: "pane", active: visible, onClose: close, onUnreadChange: state_1.setUnread, openReq: openReq });
    };
}
...
function CauButton(props) {
    ...
    const noSession = official_1.USE_OFFICIAL_SIDEBAR && sessionsReady && !sessionId;
    const [open, setOpen] = (0, react_1.useState)(false); // 仅浮层（回退）模式使用
    ...
    (0, react_1.useEffect)(() => {
        if (official_1.USE_OFFICIAL_SIDEBAR)
            return;
        return (0, bus_1.subscribeBus)(() => {
     ...
     */
    const onClick = () => {
        if (official_1.USE_OFFICIAL_SIDEBAR && (0, official_1.toggleCau)())
            return;
        setOpen((o) => !o);
    };
    const expanded = official_1.USE_OFFICIAL_SIDEBAR ? tabOpen || open : open;
    const title = noSession
        ...
        : wide
            ...
            : count > 0
                ? `农大门户 · ${count} 条未读`
                : '农大门户';
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_pillRow", ref: rowRef, children: (0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_pill", "aria-label": "\u519C\u5927\u95E8\u6237", "aria-expanded": expanded, "aria-disabled": noSession || undefined, disabled: noSession, onClick: onClick, title: title, children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_cauLogo", children: "CAU" }), wide && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_pillName dsh-cau_songtiName", children: "\u4E2D\u56FD\u519C\u4E1A\u5927\u5B66" }), wide && count > 0 && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_pillCount", children: count })] }) }), open && ((0, jsx_runtime_1.jsx)(panel_1.CauPanel, { outsideIgnore: rowRef.current, onClose: () => setOpen(false), onUnreadChange: state_1.setUnread }))] }));
}
...
function apply(ctx) {
    ...
    ctx.effect(() => (0, official_1.followSessions)(ctx), 'cau-portal: follow sessions');
