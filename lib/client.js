...
function ManageView(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_bread", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_backBtn", onClick: onBack, children: "\u2039 \u9000\u51FA\u7BA1\u7406" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_breadPath", children: "\u6570\u636E\u7BA1\u7406" })] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mgIntro", children: "\u9009\u62E9\u8981\u5220\u9664\u7684\u6570\u636E\uFF08\u65E7\u6570\u636E = \u8D85\u8FC7 2 \u4E2A\u6708\uFF09\u3002\u5220\u9664\u4E0D\u53EF\u6062\u590D\uFF1A\u672C\u5730\u7ACB\u5373\u9690\u85CF\uFF0C\u4E91\u7AEF\u5C06\u4E8E\u4E0B\u4E00\u8F6E\u6293\u53D6\uFF08\u22642 \u5C0F\u65F6\uFF09\u540E\u771F\u6B63\u5220\u9664\uFF1B\u5173\u6CE8\u4E2D\u7684\u6587\u7AE0\u5C06\u4FDD\u7559\u672C\u5730\u7F13\u5B58\u53EF\u8BFB\u3002" }), phase === 'loading' && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_loading", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_spinner" }), (0, jsx_runtime_1.jsx)("span", { children: "\u52A0\u8F7D\u6570\u636E\u76EE\u5F55\u2026" })] })), phase === 'error' && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mgMsg error", children: error }), phase === 'ready' && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgToolbar", children: [(0, jsx_runtime_1.jsx)("input", { className: "dsh-cau_mgSearch", type: "search", placeholder: "\u641C\u7D22\u6807\u9898\u6216\u94FE\u63A5\u2026\uFF08\u4E0E\u7B5B\u9009\u53E0\u52A0\uFF09", value: query, onChange: (e) => setQuery(e.target.value) }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgFilters", children: [['all', 'old', 'new'].map((k) => ((0, jsx_runtime_1.jsx)("button", { type: "button", className: 'dsh-cau_mgChip' + (filter === k ? ' on' : ''), onClick: () => setFilter(k), children: k === 'all' ? `全部 ${rows.length}` : k === 'old' ? `旧数据 ${oldCount}` : '近 2 个月' }, k))), (0, jsx_runtime_1.jsxs)("select", { className: "dsh-cau_mgSel", value: siteFilter, onChange: (e) => setSiteFilter(e.target.value), title: "\u6309\u7AD9\u70B9\u7B5B\u9009", children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: "\u5168\u90E8\u7AD9\u70B9" }), sites.map(([k, n]) => ((0, jsx_runtime_1.jsx)("option", { value: k, children: n }, k)))] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgActs", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_mgBtn", onClick: selectAllOld, title: "\u52FE\u9009\u5168\u90E8\u8D85\u8FC7 2 \u4E2A\u6708\u7684\u6570\u636E", children: "\u9009\u62E9\u5168\u90E8\u65E7\u6570\u636E" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_mgBtn", onClick: clearSel, disabled: !sel.size, children: "\u6E05\u7A7A\u9009\u62E9" })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgBar", children: ["\u5DF2\u9009 ", (0, jsx_runtime_1.jsx)("b", { children: sel.size }), " \u6761\uFF08\u65E7 ", selOld, " \u00B7 \u6211\u7684\u4E8B\u9879 ", selMine, " \u00B7 \u5173\u6CE8\u4E2D ", selFollow, "\uFF09", (0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-cau_mgDel", disabled: !sel.size || busy, onClick: () => setConfirm(true), children: ["\u5220\u9664\u6240\u9009\uFF08", sel.size, "\uFF09"] })] }), confirm && ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgConfirm", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgConfirmText", children: ["\u786E\u5B9A\u5220\u9664\u6240\u9009 ", (0, jsx_runtime_1.jsx)("b", { children: sel.size }), " \u6761\u6570\u636E\uFF1F", ' ', (selMine > 0 || selFollow > 0) && ((0, jsx_runtime_1.jsx)("b", { style: { color: 'var(--dsw-alias-state-warn,#b8860b)' }, children: [selMine > 0 && `${selMine} 条我的事项`, selFollow > 0 && `${selFollow} 条关注中`].filter(Boolean).join('，') })), ' ', (selMine > 0 || selFollow > 0) && (0, jsx_runtime_1.jsx)("span", { children: "\uFF08\u672C\u5730\u7F13\u5B58\u4ECD\u53EF\u8BFB\uFF0C\u4F46\u4E91\u7AEF\u5C06\u5220\u9664\uFF0C\u6211\u7684\u4E8B\u9879\u539F\u6587\u94FE\u63A5\u5C06\u5931\u6548\uFF09" }), "\u5220\u9664\u4E0D\u53EF\u6062\u590D\u3002"] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgConfirmActs", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_mgBtn warn", disabled: busy, onClick: () => void doDelete(), children: busy ? '提交中…' : '确认删除' }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_mgBtn", disabled: busy, onClick: () => setConfirm(false), children: "\u53D6\u6D88" })] })] })), done && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mgMsg ok", children: done }), error && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mgMsg error", children: error }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgList", children: [shown.length === 0 && (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_empty", children: "\u6CA1\u6709\u7B26\u5408\u6761\u4EF6\u7684\u6570\u636E" }), sites
                                ...
                                .map((g) => ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_mgGroup", children: [(0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_mgGroupName", children: g.n }), g.items.map((r) => {
                                        ...
                                        return ((0, jsx_runtime_1.jsxs)("label", { className: 'dsh-cau_mgRow' + (selMineRow ? ' pro' : ''), children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: sel.has(r.id), onChange: () => toggle(r.id) }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_mgRowMain", children: [(0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_mgRowTitle", children: [highlight(r.title, query), r.mined && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mgMine", title: "\u6211\u7684\u4E8B\u9879", children: "\u25CE" }), r.followed && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mgStar", title: "\u5173\u6CE8\u4E2D", children: "\u2605" })] }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_mgRowSub", children: [r.colName, r.date ? ` · ${r.date}` : '', r.isOld && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mgOld", children: "\u8D85\u8FC7 2 \u4E2A\u6708" }), r.url && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_mgRowUrl", children: highlight(r.url, query) })] })] })] }, r.id));
                                    })] }, g.k)))] })] }))] }));
}
...
function DeadlinesView(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_view", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_bread", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-cau_backBtn", onClick: onBack, children: "\u2039 \u8FD4\u56DE" }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_breadPath", children: "\u5168\u90E8\u5F85\u529E" })] }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_dlHint", children: "\u6240\u6709\u542B\u622A\u6B62\u65E5\u671F\u7684\u4E8B\u9879\uFF08\u672A\u8FC7\u671F\uFF0C\u6309\u622A\u6B62\u65E5\u5347\u5E8F\uFF09\u3002\u300C\u2B50 \u6211\u7684\u4E8B\u9879\u300D\u53EF\u7CBE\u9009\u5230\u9996\u9875\u5927\u5361\u9762\u677F\u3002" }), (0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_chips", style: { marginBottom: 8 }, children: [7, 30, 90, 'all'].map((k) => ((0, jsx_runtime_1.jsx)("button", { type: "button", className: 'dsh-cau_dlChip' + (range === k ? ' on' : ''), onClick: () => setRange(k), children: k === 'all' ? '全部' : `剩余 ${k} 天内` }, k))) }), !summary ? ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_loading", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_spinner" }), (0, jsx_runtime_1.jsx)("span", { children: "\u52A0\u8F7D\u4E2D\u2026" })] })) : sorted.length === 0 ? ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_empty", children: ["\u5F53\u524D\u7B5B\u9009\u4E0B\u6682\u65E0\u622A\u6B62\u4E8B\u9879\uFF08\u5168\u90E8\u672A\u8FC7\u671F\u622A\u6B62\u5171 ", (summary?.deadlines || []).length, " \u6761\uFF09"] })) : ((0, jsx_runtime_1.jsx)("div", { className: "dsh-cau_dlList", children: sorted.map(({ d, n }) => {
                    const id = d.article_id || d.url;
                    const mined = !!mine[id];
                    return ((0, jsx_runtime_1.jsxs)("div", { className: 'dsh-cau_dlRow' + (n <= 1 ? ' due' : n <= 3 ? ' soon' : ''), children: [(0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_dlTop", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_dlItem", children: d.item || '截止事项' }), (0, jsx_runtime_1.jsxs)("span", { className: "dsh-cau_dlDate", children: [d.date, " \u00B7 ", n === 0 ? '今天' : `剩 ${n} 天`] }), d.column && (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_dlCol", children: d.column })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dsh-cau_dlTitleWrap", children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_dlTitle", title: d.title, onClick: () => onOpenArticle(id), children: d.title }), (0, jsx_runtime_1.jsx)("span", { className: "dsh-cau_dlAct", children: (0, jsx_runtime_1.jsx)("button", { type: "button", className: 'dsh-cau_textBtn' + (mined ? ' dsh-cau_on' : ''), disabled: busy === id, onClick: () => void toggleMine(d), children: mined ? '⭐ 已在我的事项' : '☆ 我的事项' }) })] })] }, id));
                }) }))] }));
}
/** 供首页复用：行是否已在「我的事项」 */
function mineIdOf(d) {
